...
if (isset($_POST['action']) && $_POST['action'] == 'order') {
    if (isset($_SESSION['uid'])) {
        ...
        $stmt = $conn->prepare('INSERT INTO orders (phone,address,pmode,products,amount_paid,status,uid)VALUES(?,?,?,?,?,?,?)');
        $stmt->bind_param('ssssssi', $phone, $address, $pmode, $products, $grand_total, $status, $userid);
        $stmt->execute();
        
        $select_query = "SELECT * FROM orders WHERE uid = '$userid'";
